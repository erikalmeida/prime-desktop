...
public class ControladorCitasAprobadas extends ControladorInicio {
	...
	protected void inicializar() {
		...
		ListModelList<Cita> modeloCitas = new ListModelList<Cita>(servicioCita.listarCitasAprobadas());
		modeloCitas.setMultiple(false);
		listCitasA.setModel(modeloCitas);
		listCitasA.setMultiple(false);
		listCitasA.setCheckmark(false);
	}
